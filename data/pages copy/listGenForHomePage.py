...
content = {
"农/林/牧/渔" : ['种类', '种植流程', '产量数据', '成本', '行业', '标准', '文档'],
"采矿业" : ['流程', '技术', '选矿', '设备','成本', '行业', '标准', '文档'],
"制造业" : ['流程', '工艺', '原理', '原料','技术','设备', '成本','行业', '标准', '文档'],
"电力/热力/燃气/水" : ['流程', '原理','产业结构', '成本', '机构', '标准', '文档'],
"建筑业" : [ '施工', '材料', '安全检验', '成本', '行业', '标准', '文档'],
"批发和零售业" : ['层级', '仓储', '物流', '成本', '行业', '标准', '文档'],
"交通运输/仓储/邮政" : ['网点密度', '效率', '技术背景', '成本', '行业', '标准', '文档'],
"住宿和餐饮业" : ['网点密度',  '收益管理', '客流曲线', '成本', '行业', '标准', '文档'],
"信息传输/软件/信息技术服务" : ['技术', '原理', '面向群体', '成本', '行业', '标准', '文档'],
"金融业" : ['市场主体', '资金效率', '风险', '成本', '行业', '标准', '文档'],
"房地产业" : ['政策', '资质', '资金规模', '成本', '行业', '标准', '文档'],
"租赁和商务服务" : ['经营范围', '模式', '分布密度', '成本', '行业', '标准', '文档'],
"科学研究和技术服务" : ['技术现状', '应用场景', '案例', '成本', '行业', '标准', '文档'],
"水利/环境/公共设施管理" : ['管理部门', '流程', '技术', '成本', '行业', '标准', '文档'],
"居民服务/修理/其他服务" : ['经营范围', '分布密度', '面向群体', '成本', '行业', '标准', '文档'],
"教育" : ['分布密度', '教师', '资金规模',  '行业', '标准', '文档'],
"卫生/社会工作" : ['政策', '资质', '分布密度', '成本', '行业', '标准', '文档'],
"文化/体育/娱乐业" : ['面向群体', '组织结构', '传播', '成本', '行业', '标准', '文档'],
"公共管理/社会保障/社会组织" : ['职能', '面向群体', '规模', '资金', '成本', '标准', '文档'],
"国际组织" : ['组织结构', '组织规模', '职能', '资金', '行业', '标准', '文档'],
}
...
{'id': "I",	 'name' :"信息传输/软件/信息技术服务",				'open': '', 'subclass':[
...
{'id': "L",	 'name' :"租赁和商务服务",				'open': '', 'subclass':[
...
{'id': "M",	 'name' :"科学研究和技术服务",				'open': '', 'subclass':[
...
{'id': "N",	 'name' :"水利/环境/公共设施管理",				'open': '', 'subclass':[
...
{'id': "O",	 'name' :"居民服务/修理/其他服务",				'open': '', 'subclass':[
...
def save(lv3name, lv1name, dirname):
    filename = lv3name + '.txt'
    print filename
    print lv1name
    ...
    text.write('======简介======\n')
    text.write('这个条目暂时没有任何内容\n')

    for item in content[lv1name] :
        text.write('======' + item + '======\n')
    text.close()
